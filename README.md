...
## Validation & Results (Live System Proofs)

> [!NOTE]
> Below are real-world examples of the system extracting data from live Cian.ru listings and predicting their prices, compared against the official listing information.

### Example 1: High-Rise Apartment
**Listing**: [Cian Listing 1](https://www.cian.ru/sale/flat/323822282/)

````carousel
![Listing Reference Page](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Input%201%20Ref.png)
<!-- slide -->
![System Processing URL](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Input%201.png)
<!-- slide -->
![Prediction Result](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Output%201.png)
````
...
````carousel
![Listing Reference Page](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Input%202%20Ref.png)
<!-- slide -->
![System Processing URL](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Input%202.png)
<!-- slide -->
![Prediction Result](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Output%202.png)
````
...
````carousel
![Listing Reference Page](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Input%203%20Ref.png)
<!-- slide -->
![System Processing URL](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Input%203.png)
<!-- slide -->
![Prediction Result](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Output%203.png)
````
...
````carousel
![Listing Reference Page](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Input%204%20Ref.png)
<!-- slide -->
![System Processing URL](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Input%204.png)
<!-- slide -->
![Prediction Result](file:///d:/work/linkedIn/Samolet-Russia/proof's/Link-Based%20Output%204.png)
````
...
````carousel
![Manual Parameter Entry](file:///d:/work/linkedIn/Samolet-Russia/proof's/Manual%20Input%201.png)
<!-- slide -->
![Manual Entry Result](file:///d:/work/linkedIn/Samolet-Russia/proof's/Manual%20Output%201.png)
````
